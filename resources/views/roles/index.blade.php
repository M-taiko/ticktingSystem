                                ...
                                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3" style="width: inherit;">
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        <li class="breadcrumb-item text-muted">
                                            <a href="role" class="text-muted text-hover-primary">All Roles Role</a>
                                        </li>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                            ...
                                            <a class="btn btn-primary btn-sm" href="{{ route('roles.create') }}">Add New Role <i class="fa-solid fa-plus" style='font-size: 25px;'></i> </a>
