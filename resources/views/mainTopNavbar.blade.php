	    ...
	    <div class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
	        ...
	        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
	            <a href="/dashboard" class="d-lg-none">
	                <img alt="Logo" src="assets/media/logos/logo-food.png" class="h-30px" />
	            </a>
	        </div>
	        <!--end::Mobile logo-->
	        ...
	        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
	                ...
	                <div class="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0" id="kt_app_header_menu" data-kt-menu="true">
	                    ...
	                    <div class="menu-item here show menu-here-bg menu-lg-down-accordion me-0 me-lg-2">
	                        ...
	                        <span class="menu-link">
	                            <a href="/dashboard" class="menu-title btn-sm"> Home Page</a>
	            ...
	            <!--begin::Navbar-->
	            <!--
							<audio id="notification-sound" src="/assets/media/sound/notifecation.mp3" autoplay>
	                ...
	                <div class="app-navbar-item ms-1 ms-md-3" id="kt_header_user_menu_toggle">
	                    ...
	                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
	                            ...
	                            <div class="menu-content d-flex align-items-center px-3">
	                                ...
	                                <div class="d-flex flex-column">
	                                    <div class="fw-bold d-flex align-items-center fs-5">{{Auth::user()->name}}
	                                        <?php
													$userbatch = Auth::user()->UserRole;
													 foreach ($userbatch as $user) {
												
                                                          echo " <label class='badge badge-success'> $user </label> ";
	                        ...
	                        <div class="menu-item px-5">
	                            ...
	                            <a class="menu-link d-flex px-5" href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();"><i class="bx bx-log-out"></i>Sign Out</a>
