                                ...
                                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                            ...
                                            <div class="col" style="width:39rem; margin-left: 16px;">
                                                <div class="card p-10" style="width:39rem">
                                                    ...
                                                    <div id="kt_activities_scroll"
                                                        ...
                                                        data-kt-scroll-offset="5px" style="height: 279px;">
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content modal-content-demo">
                                                <div class="modal-header">
                                                    <h6 class="modal-title">Add New Resolve </h6><button
                                                        aria-label="Close" class="close btn" data-bs-dismiss="modal"
                                                        type="button"><span
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('comments.store') }}" method="post">
                                                        ...
                                                        <div class="input-group mb-3 d-none">
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text"
                                                                    id="ticket_id">ticket_id</span>
                                                            </div>

                                                            <select name="ticket_id" required id="select-beast"
                                                        ...
                                                        <div class="input-group mb-3 d-none">
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text"
                                                                    id="user_id">user_id</span>
                                                            </div>
                                                            <select name="user_id" required id="select-beast"
                                                                class="form-control  nice-select  custom-select">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text"
                                                                    id="solving_User">Solving User</span>
                                                            </div>
                                                            <select name="solving_User" required id="solving_User"
                                                                class="form-control  nice-select  custom-select">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <textarea class="form-control"name="comment_text" required id="TicketDetails"
                                                                placeholder="write the Details of your Resolve ....." id="comment_text" rows="3"
                                                                aria-describedby="comment_text"></textarea>
                                                        </div>
                                    ...
                                    <div class="modal" id="modaldemo12">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content modal-content-demo">
                                                <div class="modal-header">
                                                    <h6 class="modal-title"> Edit Resolve status</h6><button
                                                        aria-label="Close" class="close btn" data-bs-dismiss="modal"
                                                        type="button"><span
                                                            aria-hidden="true">&times;</span></button>
                                                </div>
