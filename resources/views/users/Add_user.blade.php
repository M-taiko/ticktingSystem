                                ...
                                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3" style="width: inherit;">
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        <li class="breadcrumb-item text-muted">
                                            <a href="departmentes" class="text-muted text-hover-primary">Add New Users</a>
                                        </li>
                                            ...
                                            <form class="parsley-style-1" id="selectForm2" autocomplete="off" name="selectForm2" action="{{route('users.store','test')}}" method="post">
                                                ...
                                                <div class="">
                                                    ...
                                                    <div class="row ">
                                                        <div class="parsley-input col-md-6" id="fnWrapper">
                                                            ...
                                                            <input class="form-control form-control " data-parsley-class-handler="#lnWrapper" name="name" required="" type="text">
                                                        </div>

                                                        <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                                                            <label>Login Email: <span class="tx-danger">*</span></label>
                                                            <input class="form-control form-control" data-parsley-class-handler="#lnWrapper" name="email" required="" type="email">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                                                        ...
                                                        <input class="form-control form-control" data-parsley-class-handler="#lnWrapper" name="password" required="" type="password">
                                                    </div>

                                                    <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                                                        <label> Confirm Password: <span class="tx-danger">*</span></label>
                                                        <input class="form-control form-control " data-parsley-class-handler="#lnWrapper" name="confirm-password" required="" type="password">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        ...
                                                        <select name="DepartmentName" id="select-beast" class="form-control  nice-select  custom-select">
                                                        <?php 
                                                    ...
                                                    <div class="parsley-input col-lg-6" id="fnWrapper">
                                                            <label>User Title: <span class="tx-danger">*</span></label>
                                                            <input class="form-control form-control " data-parsley-class-handler="#lnWrapper" name="userTitle" required="" type="text">
                                                        </div>
                                                </div>
                                                ...
                                                <div class="row ">
                                                    <div class="col-xs-12 col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            {!! Form::select('UserRole[]', $roles,[], array('class' => 'form-control','multiple')) !!}
                                                        </div>
                                                    </div>
                                                </div>
