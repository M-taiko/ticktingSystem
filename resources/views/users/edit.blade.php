...
<head>
    <base href="../" />
    <title>Foodnation User Editing</title>
    <meta charset="utf-8" />
        ...
        <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
            ...
            <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
                ...
                <div class="alert alert-danger">
                    <button aria-label="Close" class="close btn" data-bs-dismiss="alert" type="button">
                                ...
                                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3" style="width: inherit;">
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        <li class="breadcrumb-item text-muted">
                                            <a href="users" class="text-muted text-hover-primary">Edit User</a>
                                        </li>
                                         ...
                                         {!! Form::model($user, ['method' => 'PATCH','route' => ['users.update', $user->id]]) !!}
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="parsley-input col-lg-6" id="fnWrapper">
                                                     ...
                                                     {!! Form::text('userTitle', null, array('class' => 'form-control','required')) !!}
