                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="table-responsive">
                                                    <table id="problemtype" class="table bg-light m-5 p-5  table-bordered key-buttons text-md-nowrap text-center" style="width:100%">
                                                        <thead>
                                                            <tr>
                                                                <th class="border-bottom-0 text-center">#</th>
                                                                <th class="border-bottom-0 text-center"> Problem Name </th>
                                                                <th class="border-bottom-0 text-center"> Problem Type </th>
